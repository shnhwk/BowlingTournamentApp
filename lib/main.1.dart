...
//         title: Text(title),
//       ),
//       body: FutureBuilder<List<Bowler>>(
...
// Future<List<Bowler>> fetchPhotos(http.Client client) async => client
//       .get('https://bowlingtournamentapi.azurewebsites.net/api/bowlers')
//       .then((http.Response response){

//             var data = json.decode(response.body);
//             final list = data.map<Bowler>((json) => Bowler.fromJson(json)).toList();
